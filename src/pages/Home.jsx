...
function Home() {
  ...
  const [heroSearch, setHeroSearch] =
    useState('')
  const [heroCity, setHeroCity] =
    useState('')
      ...
      >
        <div className="accessibility-container">
          <div className="section-heading">
            <h2>
              Explore by accessibility need
            </h2>

            <p>
              Choose the accessibility features
              that matter to you and discover
              suitable places.
            </p>
          </div>
        ...
        <div className="featured-container">
          <div className="featured-heading">
            <div>
              ...
              <p>
                Discover places with useful
                accessibility information before
                you visit.
              </p>
            </div>
          </div>
      ...
      >
        <div className="how-it-works-container">
          <div className="how-it-works-heading">
            ...
            <p>
              Three simple steps to help you plan
              a more accessible visit.
            </p>
          </div>
          ...
          <div className="steps-grid">
            <article className="step-card">
              ...
              <p>
                Find places by name, city,
                category, and the accessibility
            ...
            <article className="step-card">
              ...
              <p>
                Review clear information about
            ...
            <article className="step-card">
              ...
              <p>
                Leave a review, report outdated
                information, or suggest a new place
      ...
      <section className="suggest-cta">
        <div className="suggest-cta-content">
          ...
          <p>
            ...
            accessible places by sharing what you
            know.
          </p>

          <Link
            to="/suggest-place"
            className="suggest-cta-button"
          >
            <HandHeart size={20} />
            Suggest a Place
          </Link>
